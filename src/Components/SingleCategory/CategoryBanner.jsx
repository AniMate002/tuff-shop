...
export default function CategoryBanner({category}){
    ...
    return(
        <div className=" tablet:flex-1 w-full bg-secondaryDarkColor px-10 rounded-lg relative pb-20 mx-auto tablet:mx-0">
            ...
            <Link to={"/products"} className=" px-5 py-3 block w-fit mx-auto bg-secondaryColor rounded-lg text-white font-medium hover:bg-white hover:text-secondaryColor transition-all">Shop Now</Link>
